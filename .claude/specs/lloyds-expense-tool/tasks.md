...
- [x] 4.3 Implement transaction table extraction and row parsing
...
- [x] 5.3 Write `test_rules.py` unit tests
...
- [x] 6.2 Implement `ClassifiedTransaction` and `ClassificationResult` dataclasses
...
- [x] 6.4 Write `test_classifier.py` unit tests
...
- [x] 7. Implement `reconciler.py` — arithmetic verification
- [x] 7.1 Implement `ReconciliationReport` dataclass
...
- [x] 7.2 Implement `reconcile(result, statement) -> ReconciliationReport`
...
- [x] 7.3 Write `test_reconciler.py` unit tests
...
- [x] 8. Implement `writer.py` — ClassificationResult to CSV
- [x] 8.1 Implement category total accumulation
...
- [x] 9.2 Wire the full pipeline with error handling
...
- [x] 10. Create example rules file and seed data
...
- [x] 11. Enforce code quality and coverage gates
