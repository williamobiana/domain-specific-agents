...
- [ ] 1. Extend project structure for `monzo_expense` package
...
- [ ] 4.3 Implement Pot page detection
...
- [ ] 4.4 Implement description line-joining for wrapped rows
...
- [ ] 4.5 Implement transaction table extraction and amount parsing
...
- [ ] 4.7 Create fixtures and write `tests/monzo/test_parser.py`
...
- [ ] 5.3 Write `tests/monzo/test_rules.py` unit tests
...
- [ ] 6.4 Write `tests/monzo/test_classifier.py` unit tests
...
- [ ] 7.3 Write `tests/monzo/test_splitter.py` unit tests
...
- [ ] 8.3 Write `tests/monzo/test_reconciler.py` unit tests
...
- [ ] 9.3 Create golden files and write `tests/monzo/test_writer.py`
...
- [ ] 10.3 Write `tests/monzo/test_cli.py` integration tests using `typer.testing.CliRunner`
...
- [ ] 11. Create example rules file and seed data
