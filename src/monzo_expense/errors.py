"""Typed exception hierarchy for the Monzo Expense Tool."""
...
if TYPE_CHECKING:
    ...
    from monzo_expense.reconciler import ReconciliationReport


class StatementToCsvError(Exception):
    """Base class for all Monzo Expense Tool errors."""
