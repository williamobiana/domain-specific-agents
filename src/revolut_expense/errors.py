"""Typed exception hierarchy for the Revolut Expense Tool."""
...
if TYPE_CHECKING:
    ...
    from revolut_expense.reconciler import ReconciliationReport


class StatementToCsvError(Exception):
    """Base class for all Revolut Expense Tool errors."""
